...
abstract public class TorContext {
  ...
  public TorContext(final File workingDirectory) {
  ...
  public File getHostNameFile(final String hsDir) throws IOException {
  ...
  public File getHiddenServiceDirectory(final String hsDir) {
